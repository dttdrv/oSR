...
int main(int argc, char** argv) {
    ...
    std::cout << "Specular history leak: " << result.specular_history_leak << "\n";
    std::cout << "Transparent history leak: " << result.transparent_history_leak << "\n";
    ...
    std::cout << "Sharpening amount mean: " << result.sharpening_amount_mean << "\n";
