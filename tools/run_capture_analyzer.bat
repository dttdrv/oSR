...
"%CXX%" -IC:/Users/deyan/Projects/oSR/src -std=c++20 -O2 src/tools/capture_analyzer.cpp src/debug/capture_analysis.cpp src/demo/wind_tunnel/synthetic_roi.cpp src/core/frame_context.cpp -o "%OUT%"
