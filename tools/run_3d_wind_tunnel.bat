...
"%CXX%" -IC:/Users/deyan/Projects/oSR/src -std=c++20 -O2 src/demo/manual_3d_wind_tunnel.cpp src/demo/wind_tunnel/synthetic_frame.cpp src/core/frame_context.cpp src/core/quality_mode.cpp -lgdi32 -luser32 -lcomctl32 -o "%OUT%"
if errorlevel 1 (
  echo.
  echo Build failed.
  pause
