...
"%CXX%" -IC:/Users/deyan/Projects/oSR/src -std=c++20 -O2 src/tools/capture_compare.cpp src/debug/capture_compare.cpp src/debug/capture_pack.cpp src/core/frame_context.cpp -o build\manual\osr_capture_compare.exe
