...
"%CXX%" -IC:/Users/deyan/Projects/oSR/src -std=c++20 src/tests/capture_pack_tests.cpp src/debug/capture_pack.cpp src/debug/frame_context_readiness.cpp src/core/frame_context.cpp -o build\manual\osr_capture_pack_tests.exe && build\manual\osr_capture_pack_tests.exe
if errorlevel 1 goto fail
...
"%CXX%" -IC:/Users/deyan/Projects/oSR/src -std=c++20 src/tests/capture_compare_tests.cpp src/debug/capture_compare.cpp src/debug/capture_pack.cpp src/debug/frame_context_readiness.cpp src/core/frame_context.cpp -o build\manual\osr_capture_compare_tests.exe && build\manual\osr_capture_compare_tests.exe
if errorlevel 1 goto fail
